...
const HomePage: React.FC = () => {
  ...
  <div className='flex flex-col max-[500px]:hidden items-start gap-2 profilpiced w-[30%] h-[auto] max-[680px]:h-[150px] max-[680px]:w-full max-[680px]:mb-10 rounded-WL max-[900px]:w-[40%]' >
