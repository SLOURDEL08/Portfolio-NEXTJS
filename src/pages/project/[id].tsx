        ...
        <Main className='overflow-hidden p-24 max-[900px]:p-8'>
          <div className='grid pt-2 grid-cols-1 gap-10 py-4 max-[900px]:pt-16 max-[900px]:pb-0'>
            <div className='flex gap-8 items-center justify-center max-[900px]:justify-start max-md:gap-4 '>
              <Image src={project.symbol} width="50" height="50" alt='de' className='min-w-[45px] min-h-[45px] object-cover filesimg rounded-xl max-[900px]:w-[45px] max-[900px]:h-[45px] shadowingsymbol'/>
              ...
              {selectedSection === 'presentation' && (
                <div className='presentation-block flex flex-col gap-8 '>
                  <div className='liens-block relative overflow-hidden gap-10 max-[1100px]:flex-col'>
                    <Image src={project.image} width="800" height="500" alt='de' className='w-[100%]  h-[200px] object-cover object-top rounded-xl  border-gray-800'/>
                    <div className='absolute top-0 right-0 backdrop-blur shadowed 	 px-4 py-2 bg-[#ffffff80]
...
>
  {t(`project.${project.slug}.description.${i18n.language}`)}
                  ...
                  <div className='inline-flex justify-start gap-10 rounded-xl flex-wrap gap-y-4'>
                     ...
                     <Link href="https://github.com" className='flex gap-2 items-center overhed px-4 py-2 rounded-xl' >

                       <Typography theme="white" weight="medium" variant="body-lg" component="span" fontFamily="ClashDisplay" className="">
                         Repository 
                       </Typography>
                       <Image src="/top-right-arrow.png" width="800" height="500" alt='de' className='max-w-[14px] max-h-[14px]'/>
                    </Link>
                    ...
                    <div className='flex gap-8'>
                      ...
                      <div className='flex flex-col gap-8 w-[100%]'>
                        <div className='exp-sec'>
                          <Typography theme='white' weight='medium' variant='lead' component='span' fontFamily='ClashDisplay' className=''>
