      ...
      <div className="flex justify-between max-md:justify-start w-full">
        ...
        <div className="w-8/12 flex justify-end gap-12 max-[900px]:gap-6 items-center max-md:w-[100%]">
          <div className="navbar-end flex gap-12 max-[900px]:gap-6 items-center ">
            ...
            <div className={`bg-[#ffffff20] ${hasText ? 'bg-[#7A24E8]' : 'hover:bg-[#7A24E8]'} active:bg-[#7A24E8] focus-within:bg-[#7A24E8]  transz hover:text-white contain-searchform p-2.5 rounded-md px-4 relative formtypesearch`}>
            ...
            <div className=" flex justify-start ">
              <div className="flex items-center gap-4 mt-10 max-[900px]:mt-6 flex-wrap hidened">
                <Link href="/" className={`handled p-3 px-4 flex items-center  max-[900px]:gap-3 justify-center gap-4 rounded-lg ${router.pathname === "/" ? "activesection" : ""}`}>
                  <Image width="100" height="100" alt="menu icon" src="/homet.png" className="min-h-[20px] min-w-[20px] w-[45px] h-[45px] max-xml:h-[20px] max-xml:w-[20px]" />
                  {router.pathname === "/" ? (
                ...
                <Link href="/aboutpage" className={`handled p-3 px-4 max-[900px]:gap-3 flex items-center justify-center gap-4 rounded-lg ${router.pathname === "/aboutpage" ? "activesection" : ""}`}>
                  <Image width="100" height="100" alt="menu icon" src="/docufile.png" className="min-h-[20px] min-w-[20px] w-[45px] h-[45px] max-xml:h-[20px] max-xml:w-[20px]" />
                ...
                <Link href="/projects" className={`handled p-3 px-4 max-[900px]:gap-3 flex items-center justify-center gap-4 rounded-lg ${router.pathname === "/projects" ? "activesection" : ""}`}>
                  <Image width="100" height="100" alt="menu icon" src="/layers.png" className="min-h-[20px] min-w-[20px] w-[45px] h-[45px] max-xml:h-[20px] max-xml:w-[20px]" />
                ...
                <Link href="/contact" className={`handled p-3 px-4 max-[900px]:gap-3 flex items-center justify-center gap-4 rounded-lg ${router.pathname === "/contact" ? "activesection" : ""}`}>
                  <Image width="100" height="100" alt="menu icon" src="/chat.png" className="min-h-[20px] min-w-[20px] w-[45px] h-[45px] max-xml:h-[20px] max-xml:w-[20px]" />
